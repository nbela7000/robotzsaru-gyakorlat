        ...
        if(getUserRankPerm($_SESSION['badge_number']) >= 0) {
            ...
            <div id='files-content'>
                ...
                <table id='files'>
                    ...
                    $result = mysqli_query($mysql_id, "SELECT files.*, users.playername FROM files INNER JOIN users ON users.badge_number=files.author WHERE files.archive='1' ORDER BY created DESC");
